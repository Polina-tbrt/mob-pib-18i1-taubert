...
public class Program {
    ...
    private static Shop readShop() throws FileNotFoundException {
        ...
        try(Scanner sc = new Scanner(file)) {
            ...
            while (sc.hasNextLine()) {
                ...
                Product pr = new Product(Integer.parseInt(productInfo[0]), productInfo[1], Double.parseDouble(productInfo[2]));
                products.add(pr);
            }
